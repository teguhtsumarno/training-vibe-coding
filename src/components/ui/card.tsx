...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base leading-snug font-medium text-[#121317] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-[#E1E6EC] bg-[#F8F9FC] p-(--card-spacing)",
        className
      )}
      {...props}
    />
